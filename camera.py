...
def predict(img_path, knn_clf=None, model_path=None, threshold=0.3):  # 6 needs 40+ accuracy, 4 needs 60+ accuracy
    ...
    def get_frame(self):
        while True:
            ...
            if cv2.waitKey(1) & 0xFF == ord('q'):
                break
            if nameprediction !='unknown':
                ret, jpg = cv2.imencode('.jpg', frame)
                return jpg.tobytes(), nameprediction
